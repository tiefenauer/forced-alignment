...
class CorpusEntry(object):
    ...
    def summary(self):
        ...
        print(f'# speech segments (unaligned): {len(self.speech_segments_unaligned)}')
        print(f'# pause segments: {len(self.pause_segments)}')
        print(f'# speech segments containing numbers in transcript: {len(self.speech_segments_numeric)}')
        print(f'# speech segments not containing numbers in transcript: {len(self.speech_segments_not_numeric)}')
        print('-----------------------------------------------------------')
