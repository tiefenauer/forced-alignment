...
audio_file = os.path.join('E:', 'librispeech-corpus', '1.wav')

corpus = load_corpus(r'E:\librispeech-corpus')
corpus.summary()
...
with sr.AudioFile(audio_file) as source:
    ...
    print(f'{len(voiced_segments)} voiced segments')
    for segment in voiced_segments:
        audio = sr.AudioData(frame_data=segment, sample_rate=corpus_entry.rate, sample_width=1)
        try:
