...
from util.e2e_util import create_demo_from_corpus_entry, create_demo
...
parser.add_argument('-t', '--transcript', type=str, nargs='?',
...
if __name__ == '__main__':
    if args.corpus:
        ...
        create_demo(abspath(args.audio), abspath(args.transcript))
